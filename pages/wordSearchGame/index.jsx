...
const WordSearchGame = () => {
    ...
    const {wsgDetails, updateWSGDetails} =
    useShoppingCart();
    ...
    return ( 
        <>
            {(timeUp || win )&& (<div id="wsg-overlay">
                <div id="wsg-card" className="wsg-flex w-[90%] lg:w-[60%]">
                <div className="wsg-flexCol wsg-vertical-centre">
                    <h1 id="win-lose" className='text-[30px]'>{attemptsLeft!=0? win?'You Win 🎉':'You Lose 😢':"Game Over"}</h1>
                    <div className=" balance attempts-balance">You have {attemptsLeft!=0?attemptsLeft: 'used up all '} attempts left</div>
                    
                    <div className=" balance wallet-balance">Your game wallet balance is ₦{userDetails.gameWalletBalance}{win?' + ₦'+reward:''}</div>
                    ...
                    <button className="wsg-button btn-lg sec-button" id="home" onClick={()=>{router.back(), document.querySelector('.footer').style.visibility = 'visible'}}>
                    Back to Shopping
                    </button>
                </div>
                </div>
            ...
            <div id="game wsg-flexCol">
                ...
                <h2 className="text-[3rem] text-[orange] text-center mt-[2rem]" id="selected-letters">Word Search</h2>
                <div className="wsg-flex mt-[10px]">
                    <div className="wsg-flexCol game-control text-center">
                      <div className='h-[45px] flex items-center'>Attempts Remaining</div>
                    ...
                    <div id="timer" className="play-info">---</div>
                    </div>
                </div>
